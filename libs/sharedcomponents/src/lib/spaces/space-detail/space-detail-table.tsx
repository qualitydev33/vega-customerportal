...
import { DataGridCustomToolbar, FormatNumberUSDHundredth, vegaTableControls } from '@vegaplatformui/sharedcomponents';
import { useRecoilState } from 'recoil';

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface ISpaceDetailTableProps {
...
const SpaceDetailTable: React.FC<ISpaceDetailTableProps> = (props) => {
    ...
    const paginationModel = tableControls.find((control) => control.key === 'space-detail-table')?.value.paginationModel;
                ...
                onPaginationModelChange={(p) => {
                    setTableControls((controls) => {
                        return controls.map((control) => {
                            if (control.key === 'space-detail-table') {
...
const useStyles = makeStyles<ISpaceDetailTableProps>()((theme, props) => ({
    ToolBar: {
