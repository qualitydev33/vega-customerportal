...
export interface IWorkloadDetailTableProps {
...
const WorkloadDetailTable: React.FC<IWorkloadDetailTableProps> = (props) => {
...
const useStyles = makeStyles<IWorkloadDetailTableProps>()((theme, props) => ({
    ToolBar: {
